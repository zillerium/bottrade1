...
*/
    ...
    let jsonout = { avgrange:  parseFloat(lastminAvg[0]["avgrange"]), 
	    inrange: ((minprice10min > range5minLow) && (minprice10min < range5minHigh)), 
	    inrangebuy: ((buyprice> range5minLow) && (buyprice < range5minHigh)), 
